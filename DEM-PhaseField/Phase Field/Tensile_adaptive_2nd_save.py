...
if __name__ == "__main__":
    ...
    foldername = 'TensionPlate_save'    
    createFolder('./'+ foldername + '/')
    targetDir = os.path.join(originalDir, './'+ foldername + '/')
    os.chdir(targetDir)
    ...
    for iStep in range(0,nSteps):
        ...
        while (keepTraining > 0) and (miter < maxInnerIter):
            ...
            if (len(elem_refine) > 0) and (iStep < 2):
                ...
                scipy.io.savemat('../X_f_Tensile_2nd.mat', {'X_f': X_f})
    ...
    print('Quadrature points saved in X_f_Tensile_2nd.mat for Tensile_adaptive_2nd_load')